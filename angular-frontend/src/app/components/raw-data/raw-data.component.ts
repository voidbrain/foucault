            ...
            <ion-col size="6">
              ...
              <ion-text
                ...
                <ng-container *ngIf="accelData; else loadingAccel">
                  X: {{ accelData.accelX | number:'1.0-0' || null }} m/s<sup>2</sup> <br />
                  Y: {{ accelData.accelY | number:'1.0-0' || null }} m/s<sup>2</sup> <br />
                  Z: {{ accelData.accelZ | number:'1.0-0' || null }} m/s<sup>2</sup>
                </ng-container>
