          ...
          <ion-row>
            <ion-col size="6">
              ...
              <div id="motor-content">
                <span id="left-motor">
                  Left Motor PWM:
                  <span id="left-motor-value">{{ leftMotorPWM?.value | number:'1.4-4' || '_' }}</span>
                </span>
                <br />
                <span id="right-motor">
                  Right Motor PWM:
                  <span id="right-motor-value">{{ rightMotorPWM?.value | number:'1.4-4' || '_' }}</span>
                </span>
              </div>
            </ion-col>
            <ion-col size="6">
              ...
              <div id="servo-content">
                <span id="left-servo">
                  Left Servo Pulse:
                  <span id="left-servo-value">{{ leftServoPulse?.value | number:'1.4-4' || '_' }}</span>µs
                </span>
                <br />
                <span id="right-servo">
                  Right Servo Pulse:
                  <span id="right-servo-value">{{ rightServoPulse?.value | number:'1.4-4' || '_' }}</span>µs
                </span>
              </div>
            </ion-col>
          </ion-row>
